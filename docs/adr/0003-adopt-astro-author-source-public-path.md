...
metadata only when committed in projection frontmatter, committed in another
documented generated public data artifact, or produced by a documented
deploy-time public artifact workflow.
...
- Generated public data artifacts: optional cross-post indexes or feeds such as
  ...
  hand-authored.
- Deploy-time public data artifacts: optional public metadata generated after the
  source commit exists. `updatedAt` may use this path because commit-time
  `project:content` cannot reliably know the final source commit timestamp.
...
- Deploy-time public data may be generated into additional artifacts when a value
  depends on post-commit repository history, such as `updatedAt`.
